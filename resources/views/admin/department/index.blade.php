                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="department_name" placeholder="Department department name">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-10">
                                                        <div class="form-group">
                                                            ...
                                                            <span class="text-danger error-text update_department_name_error"></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <div class="form-group mt-1">
...
<script>
    $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status == 400) {
                        ...
                        toastr.success('Department store successfully.');
                    }
                }
            });
        });
        ...
        $('#editForm').submit(function (event) {
            ...
            var url = "{{ route('admin.department.update', ":id") }}";
            url = url.replace(':id', id)
            $.ajax({
                url: url,
                type: "PUT",
