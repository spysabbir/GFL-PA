...
<script>
    $(document).ready(function() {
        ...
        $('#allDataTable').DataTable({
            ...
            searching: true,
            ajax: {
                url: "{{ route('employee.color.index') }}",
                "data":function(e){
        ...
        $('#createForm').submit(function(event) {
            ...
            $.ajax({
                url: "{{ route('employee.color.store') }}",
                type: 'POST',
                data: formData,
                dataType: 'json',
                beforeSend:function(){
        ...
        $(document).on('click', '.editBtn', function () {
            var id = $(this).data('id');
            var url = "{{ route('employee.color.edit', ":id") }}";
        ...
        $('#editForm').submit(function (event) {
            event.preventDefault();
            var id = $('#color_id').val();
            var url = "{{ route('employee.color.update', ":id") }}";
            url = url.replace(':id', id)
            $.ajax({
                url: url,
                type: "PUT",
        ...
        $(document).on('click', '.deleteBtn', function(){
            var id = $(this).data('id');
            var url = "{{ route('employee.color.destroy', ":id") }}";
            url = url.replace(':id', id)
            Swal.fire({
                title: 'Are you sure?',
        ...
        $('#trashedDataTable').DataTable({
            ...
            searching: true,
            ajax: {
                url: "{{ route('employee.color.trashed') }}",
            },
            columns: [
                { data: 'color_name', name: 'color_name' },
                { data: 'action', name: 'action', orderable: false, searchable: false }
        ...
        $(document).on('click', '.restoreBtn', function () {
            var id = $(this).data('id');
            var url = "{{ route('employee.color.restore', ":id") }}";
            url = url.replace(':id', id)
            $.ajax({
                url: url,
                type: "GET",
        ...
        $(document).on('click', '.forceDeleteBtn', function(){
            var id = $(this).data('id');
            var url = "{{ route('employee.color.force.delete', ":id") }}";
            url = url.replace(':id', id)
            Swal.fire({
                title: 'Are you sure?',
        ...
        $(document).on('click', '.statusBtn', function () {
            var id = $(this).data('id');
            var url = "{{ route('employee.color.status', ":id") }}";
            url = url.replace(':id', id)
            $.ajax({
                url: url,
                type: "GET",
